...
import fastcampus.aop.pjt22_free_image_finder.databinding.ItemPhotoBinding
...
class PhotoAdapter : RecyclerView.Adapter<PhotoAdapter.ViewHolder>() {
    ...
    inner class ViewHolder(
        ...
        fun bind(photo: PhotoResponse) {
            ...
            if (photo.description?.toString().isNullOrBlank()) {
                binding.descriptionTextView.visibility = View.GONE
            } else {
                binding.descriptionTextView.visibility = View.VISIBLE
                binding.descriptionTextView.text = photo.description.toString()
            }
        }
    }
