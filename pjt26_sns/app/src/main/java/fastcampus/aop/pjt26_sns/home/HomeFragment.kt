...
import fastcampus.aop.pjt26_sns.DBKey.Companion.CHILD_CHAT
import fastcampus.aop.pjt26_sns.DBKey.Companion.DB_ARTICLES
import fastcampus.aop.pjt26_sns.DBKey.Companion.DB_USERS
import fastcampus.aop.pjt26_sns.R
import fastcampus.aop.pjt26_sns.chatlist.ChatListItem
import fastcampus.aop.pjt26_sns.databinding.FragmentHomeBinding
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        articleAdapter = ArticleAdapter(onItemClicked = { articleModel ->
            if (auth.currentUser != null) {
                ...
                if (currentUser.uid != articleModel.userId) {
