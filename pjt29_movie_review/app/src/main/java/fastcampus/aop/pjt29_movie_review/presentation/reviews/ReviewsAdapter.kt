...
import fastcampus.aop.pjt29_movie_review.databinding.ItemMovieInformationBinding
import fastcampus.aop.pjt29_movie_review.databinding.ItemMyReviewBinding
import fastcampus.aop.pjt29_movie_review.databinding.ItemReviewBinding
import fastcampus.aop.pjt29_movie_review.databinding.ItemReviewFormBinding
...
class ReviewsAdapter(
    ...
    inner class MovieInformationViewHolder(
    ...
    inner class ReviewFormViewHolder(
        ...
        init {
            ...
            binding.reviewFieldEditText.addTextChangedListener { editable ->
                binding.contentLimitTextView.text = "(${editable?.length ?: 0}/100)"
    ...
    companion object {
        ...
        const val ITEM_VIEW_TYPE_MY_REVIEW = 2
        const val ITEM_VIEW_TYPE_REVIEW_FORM = 3
    }
}