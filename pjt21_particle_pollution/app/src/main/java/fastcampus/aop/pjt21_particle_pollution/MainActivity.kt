package fastcampus.aop.pjt21_particle_pollution
...
import fastcampus.aop.pjt21_particle_pollution.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onRequestPermissionsResult(
        ...
        val backgroundLocationPermissionGranted = requestCode == REQUEST_ACCESS_BACKGROUND_LOCATION_PERMISSIONS && grantResults[0] == PackageManager.PERMISSION_GRANTED
